...
root="P_1"
idx='2'
emg_raw=pd.read_csv(f"data/{root}/unfiltered_emg{idx}.txt",header=None)
emg=pd.read_csv(f"data/{root}/emg{idx}.txt",header=None)
# gt=pd.read_csv(f"data/{root}/gt.txt",sep=' ',header=None)
stim=pd.read_csv(f"data/{root}/stim{idx}.txt",header=None)
# stim=pd.read_csv(f"data/{root}/stimulus.txt",sep=' ',header=None)
# print(emg.head())
time=pd.read_csv(f"data/{root}/timestamp{idx}.txt",header=None)
# labels=pd.read_csv(f"data/{root}/labels{idx}.txt",header=None)
